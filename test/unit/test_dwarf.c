...
#if 0
			printf("CHECK { 0x%" PFMT64x ", %" PFMT32u ", %" PFMT32u ", %s%s%s }\n",
				samples_expect[i].address,
				samples_expect[i].line,
				samples_expect[i].column,
				samples_expect[i].file ? "\"" : "",
				samples_expect[i].file ? samples_expect[i].file : "NULL",
				samples_expect[i].file ? "\"" : "");
#endif
